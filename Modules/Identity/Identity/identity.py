...
def gen_identity():
    ...
    miejce_zamieszkania,nr_telefonu = gen_place()
    plec,kolor_wlosow,kolor_oczu = gen_traits()
...
def gen_traits():
    ...
    kolor_wlosow = random.choice(["Blond","Szatyn","Rude","Czarne"])
    kolor_oczu = random.choice(["Niebieskie","Zielone","Brązowe"])
...
def gen_place():
    ...
    random_county = random.choice(countries)
    miejce_zamieszkania = random_county['name']
    kod_kraju = random_county['code']
    nr_telefonu = random.randint(1000000000, 9999999999)
    nr_telefonu = str(nr_telefonu)
    nr_telefonu = kod_kraju + "-" + nr_telefonu[0:3] + "-" + nr_telefonu[3:6] + "-" + nr_telefonu[6:9]
...
def gen_pesel():
    ...
    pesel = str(a) + str(b) + str(c) + str(d) + str(e) + str(f) + str(g) + str(h) + str(i) + str(j) + str(last_digit)
    pesel = int(pesel)

    return int(pesel), data_ur
